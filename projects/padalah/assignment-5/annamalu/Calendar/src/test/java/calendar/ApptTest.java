...
public class ApptTest {
	...
	// assertions
		 ...
		 //FAILED HERE (DESCRIPTION): assertEquals("This is my birthday party.", appt.getDescription());
	...
	public void test03() throws Throwable {
		...
		assertNotEquals("	1/15/2018 at 9:30pm ,Birthday Party, This is my birthday party." +
				"\n", appt.toString());
		appt.setStartHour(10);
		assertNotEquals("	1/15/2018 at 10:30am ,Birthday Party, This is my birthday party." +
				"\n", appt.toString());
		appt.setStartHour(11);
		assertNotEquals("	1/15/2018 at 11:30am ,Birthday Party, This is my birthday party." +
				"\n", appt.toString());
